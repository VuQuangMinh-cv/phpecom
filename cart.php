...
$otp_verified = isset($_SESSION['otp_verified']) && $_SESSION['otp_verified'];
?>
<div class="wrapper">
    <div class="content">
                                ...
                                ?>
                                    ...
                                    <div id="">
                                        <?php foreach ($items as $citem) { ?>
                                            <div class="product_data shadow-sm mb-3">
                                                <div class="row align-items-center">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-2">
                                                        <h5 style="color: green;">VND <?= number_format($citem['selling_price'], 0, ',', '.') ?></h5>
                                                    </div>
                                                    <div class="col-md-2">
                                    ...
                                    <div class="float-end">
                                        ...
                                        <?php else: ?>
                                            <div class="alert alert-warning" role="alert">
                                                Bạn cần xác thực OTP để tiếp tục. <a href="send_otp.php" class="btn btn-primary btn-sm">Gửi OTP</a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                <?php } else { ?>
