        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary">
                    ...
                    <a href="order-history.php" class="btn btn-warning float-end"><i class="fa fa-reply"></i> Back</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    <label class="fw-bold">Order Date & Time</label> 
                                    <div class="border p-1"><?= $data['created_at']; ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table">
                                ...
                                $order_query = "SELECT o.id as oid, o.tracking_no, o.user_id, oi.*, oi.qty as orderqty, p.* 
                                                ...
                                                WHERE oi.order_id=o.id AND p.id=oi.prod_id
                            ...
                            <div class="border p-1 mb-3"><?= $data['payment_mode'] ?></div>
                            <label class="fw-bold">Status</label>
                            <div class="mb-3">
                                <form action="code.php" method="POST">
                                    <input type="hidden" name="tracking_no" value="<?= $data['tracking_no']?>" id="">
